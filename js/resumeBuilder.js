...
bio.display = function(){
	...
	$("#footerContacts, #topContacts").prepend(formattedLocation);
	$("#footerContacts, #topContacts").prepend(formattedEmail);
...
project.display = function(){
	for(var projId in project.projects){
		...
		for(var descriptionId in project.projects[projId].description){
